...
def patch(server, target_system, **kwargs):
    ...
    .. code-block:: bash
        ...
        salt-run suma.patch your-suma-host.cool.domain your-minion.great.biz schedule='20:30 20-02-2021'

        salt-run suma.patch your-suma-host.cool.domain your-minion.great.biz delay=15
